...
(function() {
  $(function() {
    ...
    applyListenersOnNewPopup = function(popupNew) {
      return popupNew.getNode().on({
        createNotions: function() {
          popupNew.close();
          return clearAll();
        },
        openNotions: function() {
          popupNew.close();
          if (!saver.hasSaves()) {
    ...
    popupNew.create();
    applyListenersOnNewPopup(popupNew);
