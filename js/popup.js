...
(function() {
  window.Popup = (function() {
    ...
    // Append to the popup the elements according to the bootstrap classes
    ...
    // Trigger evenment to the $popup when we click on $element
    ...
    // Create a div block with a title (on the top left of the popup) and return it
    // Can add classnames
    ...
    // Create an input text and return it
    // Can add classnames
    ...
    // Create a button with the argument text and return it
    ...
    Popup.prototype.createInputFileSave = function(name_id) {
      var $element;
      $element = $('<input></input>').attr('type', 'file').attr('nwsaveas', 'file.json');
      if ((name_id != null)) {
        $element.attr({
          name: name_id,
          id: name_id
    ...
    Popup.prototype.createSelectList = function(values, name_id, none_value) {
      ...
      // If the user don't want default value we don't add it
